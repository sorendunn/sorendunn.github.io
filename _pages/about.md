...
News
=====
- *August 3rd, 2026*: One of four main contributors leading the results in [Scaling Automated Post-Training](https://intology.ai/blog/scaling-automated-post-training): Locus sets SOTA on PostTrainBench (44.7, <ins>2.9 points</ins> ahead of the next frontier agent), reaches <ins>51.6%</ins> on PostTrainBench+ surpassing the official human-tuned Qwen3-1.7B (49.4%), ranks 4th by peak average rank across all live prize-money Kaggle competitions, and ships a production Bubble model at ~2.8× lower error and 105× lower cost.
...
- *March 14th, 2025*: Along with Intology, I debuted Zochi, an artificial scientist which produced papers averaging 7.67/10 on NeurIPS guidelines, 3 of which were accepted to [ICLR 2025 workshops](https://www.intology.ai/blog/zochi-tech-report).
...
Experience
=====
- Intology, Founding Member of Technical Staff, San Francisco, CA, January 2025 - Present
